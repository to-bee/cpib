...
public class Program implements IConcSyn.IProgram {
	...
	@Override
	public ch.fhnw.cpib.compiler.ast.interfaces.IAbsSyn.IProgram toAbs() {
		return new ch.fhnw.cpib.compiler.ast.classes.Program
				(nameToken, progList.toAbs(), optDec.toAbs(), blockCmd.toAbs());
	}
}
