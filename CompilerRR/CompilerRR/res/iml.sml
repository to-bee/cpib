...
val string_of_nonterm =
  fn expression                               => "expression"
   ...
   | repeatingOptionalCase					  => "repeatingOptionalCase"
...
(cmd,
	[[T SKIP],
	 ...
	 [T SWITCH, T IDENT, T CASE, T LITERAL, T COLON, N blockCmd, N repeatingOptionalCase, T CASEDEFAULT, T COLON, N blockCmd, T ENDSWITCH]
	 ]),
(repeatingOptionalCase,
	[[],
	 [T CASE, T LITERAL, T COLON, N blockCmd, N repeatingOptionalCase]]),	 
(optionalGlobalInits,
	[[],
	 [T INIT, N idents]]),
(idents,
